...
class BangumiList_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function output()
    {
        ...
        return '<style>.bangumi_loading{width:150px;height:150px;border-radius:50%;perspective:800px;margin:20px auto}.inner{position:absolute;box-sizing:border-box;width:100%;height:100%;border-radius:50%}.inner.one{left:0;top:0;animation:rotate-one 1s linear infinite;border-bottom:5px solid #ff73b3}.inner.two{right:0;top:0;animation:rotate-two 1s linear infinite;border-right:5px solid #ff73b3}.inner.three{right:0;bottom:0;animation:rotate-three 1s linear infinite;border-top:5px solid #ff73b3}@keyframes rotate-one{0%{transform:rotateX(35deg) rotateY(-45deg) rotateZ(0deg)}100%{transform:rotateX(35deg) rotateY(-45deg) rotateZ(360deg)}}@keyframes rotate-two{0%{transform:rotateX(50deg) rotateY(10deg) rotateZ(0deg)}100%{transform:rotateX(50deg) rotateY(10deg) rotateZ(360deg)}}@keyframes rotate-three{0%{transform:rotateX(35deg) rotateY(55deg) rotateZ(0deg)}100%{transform:rotateX(35deg) rotateY(55deg) rotateZ(360deg)}}.bangumiList{margin:20px 0}.bangumi_loading_text{text-align:center;font-size:16px;font-weight:600;color:#c7254e}.Bangumi ul{display:inline-block;vertical-align:top;margin:10px 10px 10px 0}.Bangumi ul img{width:88px;height:132px;object-fit:cover}.Bangumi ul p{width:88px;display:block;margin-block-start:1em;margin-block-end:1em;margin-inline-start:0;margin-inline-end:0;overflow-wrap:break-word}</style>' .
